...
class TabAnswerAdapter(var context: Context?)
    ...
    private lateinit var tabAnswerClickListener : TabAnswerClickListener

    fun setTabAnswerClickListener(tabAnswerClickListener: TabAnswerClickListener){
    ...
    override fun onBindViewHolder(holder: TabAnswerViewHolder, position: Int) {
